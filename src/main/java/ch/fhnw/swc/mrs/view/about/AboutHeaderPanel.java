...
public class AboutHeaderPanel extends JPanel {
    ...
    public AboutHeaderPanel(Color bColor) {
        ...
        headingLabel.setText("Software Testing and Quality Management Lab");
        descriptionLabelAbout.setText(
                "<html>A movie rental application for the " + "software Testing and Quality Management lab at the "
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup().addContainerGap().addComponent(headingLabel)
                                        .addGap(18, 18, 18).addComponent(headingTwoLabel))
